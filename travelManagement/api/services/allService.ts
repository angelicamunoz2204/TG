...
export class AllService {
    ...
    async getAllSolutions(requirements: Input) {
        ...
        const requirementsAmount = this.flightsService.getFlightsSizes().concat(this.lodgingsService.getLodgingsSizes());
        const requiredInf = this.inputDataHelper.createRequiredInformation(requirements, requirementsAmount);
